...
exports.getProductByCategory = exports.getProduct = exports.login = exports.registerdata = exports.register = void 0;
...
function getProductByCategory(req, res) {
    try {
        ...
        db_1.db.query(q, [req.params.category], (err, data) => {
            if (err)
